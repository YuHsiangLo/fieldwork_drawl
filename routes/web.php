...
#Route::get('/','ElicitationInfoController@create')->name('elicitation_info.create');
#Route::post('/generate_url','ElicitationInfoController@generate_url')->name('generate.url');

Route::get('/record/create','RecordingController@get_query')->name('record.get_query');
